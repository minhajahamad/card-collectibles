...
const Affiliates = () => {
  ...
  return (
    <div>
      ...
      <div className="flex">
        <SideBar />
        <div className="w-[75%] max-h-[600px] flex flex-col gap-3 font-sans border border-[#DEDEDE] rounded-[14px] hover:shadow-[0_0_17px_0_#00000014] transition-all duration-400 xl:mt-15 xl:px-10 xl:pt-8   scrollbar-none">
