...
const Footer = () => {
  return (
    <div className="overflow-hidden w-full flex flex-col xl:flex-row   justify-between bg-[#010816] font-raleway py-5 px-5 xl:py-10 xl:pl-15 xl:pr-10">
      ...
      <div className=" w-full flex justify-between xl:justify-end xl:gap-30  px-10 py-5 md:px-30 lg:px-50 xl:py-0 xl:px-0 ">
        <div className="flex flex-col gap-5 text-[15px] font-medium text-[#9BA3AE]  xl:w-[20%]   ">
